...
//module.exports = (() => countries.map((name, id) => ({ id,  name,  tagname: name,  description: 'this is '+name,  type: Math.random() > 0.5 ? 'label' : 'group' })))()
